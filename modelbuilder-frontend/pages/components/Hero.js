    ...
    return (
        <>
            ...
            */}
            ...
            {/* <!-- Main modal --> */}
            <div id="authentication-modal" tabIndex="-1" aria-hidden="true" className={`${showSignUp} overflow-y-auto overflow-x-hidden fixed ml-1/2 mt-32 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center`}>
                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-10 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <div className="flex justify-center">
                            <button className="inline-flex text-white bg-indigo-500/[0.85] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-500/[0.95] rounded text-lg">
                                Sign up
                            </button>

                            {/* Changed login button (old login is commented) */}
                            <button onClick={toggleSignUp} className="ml-4 inline-flex text-indigo-400 border-2 border-indigo-500 py-2 px-6 focus:outline-none hover:bg-indigo-500/[0.95] hover:text-white rounded text-lg" type="button" data-modal-toggle="authentication-modal">
                                Login
                            </button>
